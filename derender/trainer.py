...
class Trainer():
    def __init__(self, cfgs, model):
        ...
        self.log_fix_sample = cfgs.get('log_fix_sample', True)
    ...
    def train(self):
        ...
        if self.archive_code:
            utils.archive_code(os.path.join(self.checkpoint_dir, 'archived_code.zip'), file_patterns=['derender/**/*.py'])
        ...
        print(f"Training completed after {self.num_epochs} epochs.")
