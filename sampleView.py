...
vertices, faces, textures = utils.parse3SweepObjData(radcol_height,sor_circum,vertices,faces,textures,indexOffset=-5)
...
utils.save_images(os.path.join(current_dir, '3SweepData/'+inputFolder), images.detach().cpu().numpy(), suffix='sample_view', sep_folder=True)
